...
class RefineYourself extends StatefulWidget {
  const RefineYourself({Key? key}) : super(key: key);

  @override
  State<RefineYourself> createState() => _RefineYourselfState();
}

class _RefineYourselfState extends State<RefineYourself> {
  int _currentValue = 0;
  late Timer _timer;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color(0xFFF9CDCE),
        appBar: AppBar(
          leading: IconButton(
            icon: Icon(
              size: 30.0,
                ...
                children: [
                    ...
                    child: Stack(
                      children: [
                        ...
                        FAProgressBar(
                          ...
                          maxValue: 120,
                          size: 10,
                          progressColor: Color(0xFFDEA5A7),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30,),
                      Text("Step 3:\nMeditation for Setting and Achieving Goals\n(20 minutes):",style: TextStyle(fontSize: 15,),),
                      cont("Visualize your goals with clarity, imagining each step needed to achieve them."),
                      cont("Cultivate determination and a sense of purpose."),
                      cont("Cultivate determination and a sense of purpose."),
                      SizedBox(height: 20,),
